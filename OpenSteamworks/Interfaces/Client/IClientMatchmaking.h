...
public:
    ...
    virtual unknown_ret QueryServerByFakeIP() = 0; //TODO: REVERSE ME
    virtual uint64 EnsureFavoriteGameAccountsUpdated( bool bUnk ) = 0;
    virtual unknown_ret ReportGameServerPingReply() = 0; //TODO: REVERSE ME
    virtual unknown_ret QueryServerFriends() = 0; //TODO: REVERSE ME
};

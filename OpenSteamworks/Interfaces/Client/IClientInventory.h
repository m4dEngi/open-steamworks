...
public:
    ...
    virtual bool GetResultItems(SteamInventoryResult_t resultHandle, SteamItemDetails_t *pOutItemsArray, uint32 uUnk, uint32 *punOutItemsArraySize) = 0;
    virtual bool GetResultItemProperty(SteamInventoryResult_t resultHandle, uint32 unItemIndex, const char* pchPropertyName, char* pchValueBuffer, uint32 uUnk, uint32* punValueBufferSizeOut) = 0;
    ...
    virtual bool ExchangeItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayGenerate, uint32 uUnk1, const uint32 *punArrayGenerateQuantity, uint32 unArrayGenerateLength, const SteamItemInstanceID_t *pArrayDestroy, uint32 uUnk2, const uint32 *punArrayDestroyQuantity, uint32 unArrayDestroyLength) = 0;
    ...
    virtual bool TradeItems(SteamInventoryResult_t *pResultHandle, CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, uint32 uUnk1, const uint32 *pArrayGiveQuantity, uint32 nArrayGiveLength, const SteamItemInstanceID_t *pArrayGet, uint32 uUnk2, const uint32 *pArrayGetQuantity, uint32 nArrayGetLength) = 0;
    // ITEM DEFINITIONS
    //
    ...
    virtual bool GetItemDefinitionIDs( SteamItemDef_t *pItemDefIDs, uint32 uUnk, uint32 *punItemDefIDsArraySize) = 0;
    ...
    // property names.
    virtual bool GetItemDefinitionProperty(SteamItemDef_t iDefinition, const char *pchPropertyName, char *pchValueBuffer, uint32 uUnk, uint32 *punValueBufferSize) = 0;
    ...
    virtual unknown_ret TEST_ClearMsgCache() = 0; //TODO: REVERSE ME
};
